      ...
      try {
        ...
        if (userDoc.exists) {
          ...
          _emailController.text =
              user.email ?? ''; // Charger l'email de l'utilisateur
  ...
  Future<void> _pickImage() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Image sélectionnée')));
    }
  }
                ...
                builder:
                    (context) => AlertDialog(
                      ...
                      content: Column(
                        ...
                        children: [
                          Text(
                            "Pour changer l'email, entrez votre mot de passe :",
                          ),
                          TextField(
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            try {
                              ...
                              await user.updateEmail(newEmail);
                              print(
                                "✅ Email mis à jour après réauthentification !",
                              );
                            } catch (err) {
                              print(
                                "❌ Erreur de réauthentification ou d'updateEmail : $err",
                              );
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                    ...
                    _imageFile != null
                        ...
                        : (_photoUrl.isNotEmpty
                            ...
                            : AssetImage('assets/images/default_profile.png')
                                as ImageProvider),
                child:
                    _imageFile == null && _photoUrl.isEmpty
